 ...
 */
final class Version20251001152153 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP email, DROP mdp_user');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD email VARCHAR(180) NOT NULL, ADD mdp_user VARCHAR(255) NOT NULL');
